% %% Figure 2 on Carmody Diet Oscillation Data Set 
clear
clc
...
% Running TMI for k = 5 2 runs each (Comment out if you know the
% parameters well and only need one run)
...
for i= 1:5
        ...
        subplot(1,5,i)
        plot(days,Y(i,:),'k','LineWidth',1.75)
...
save('Fig2a_results','Phi','Y','days','x','N')
